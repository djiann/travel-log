...
def add_labels():
    base_img_path = "/Users/djiann/.cursor/projects/Users-djiann-VS-workspace-Travel/assets/overview_pastel.png"
    ...
    print(f"Saved pastel labeled map to {out_img_path}")
